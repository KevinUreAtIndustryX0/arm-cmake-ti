...
/* Vim Parity Register Frame Definition */
/** @struct sl_vimParBase
*   @brief Vim Parity Register Frame Definition
*
*   This type is used to access the Vim Parity Registers.
*/
/** @typedef sl_vimParBASE_t
*   @brief VIM Parity Register Frame Type Definition
*
*   This type is used to access the VIM Parity Registers.
*/
#if defined(_TMS570LS31x_) || defined(_TMS570LS12x_) || defined(_RM48x_) || defined(_RM46x_) || defined(_RM42x_) || defined(_TMS570LS04x_)
typedef volatile struct sl_vimParBase
{
...
#define sl_vimParREG ((sl_vimParBASE_t *)0xFFFFFDECU)
#endif
...
#define sl_vimREG ((sl_vimBASE_t *)0xFFFFFD00U)
#endif
