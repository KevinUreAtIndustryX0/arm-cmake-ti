...
/** @enum sl_canloopBackType
*   @brief canLoopback type definition
*/
/** @typedef sl_canloopBackType_t
...
*/
typedef enum sl_canloopBackType
{
    sl_Internal_Lbk = 0x00000010U,
    sl_External_Lbk = 0x00000100U,
	sl_Internal_Silent_Lbk = 0x00000018U
}sl_canloopBackType_t;

/** @def sl_canMESSAGE_BOX1
*   @brief Alias name for CAN message box 1
*
*   @note This value should be used for API argument @a messageBox
*/
#define sl_canMESSAGE_BOX1 1U

/** @def sl_canMESSAGE_BOX2
*   @brief Alias name for CAN message box 2
*
*   @note This value should be used for API argument @a messageBox
*/
#define sl_canMESSAGE_BOX2 2U
