...
static TPS_DMUXSignals EnabledDMUXSignal;
...
{
    /*Need to verify that the table values are correct*/
    ...
    else
    {
        ...
        *u8crc_value = 0xFFU;
        ...
        for (u32i = 32U; u32i > 0U; u32i--)
        {
            ...
            /*SAFETYMCUSW 45 D MR:21.1 <APPROVED> "Comment_5"*/
...
boolean TPS_DisableMUXDiagnostic(void)
{
    ...
    EnabledDMUXSignal = EnabledDMUXSignal;
