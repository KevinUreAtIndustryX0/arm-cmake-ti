 ...
 *---------------------------------------------------------------------------------------------------------------------
 ...
 |---------------:|:-----------:|:----------------:|:------------------:|:----------------------------|
 |2.4.0|  20Dec2012  | Manoj R          |    00000000000     | Initial version             |
 */
...
/*SAFETYMCUSW 148 S <APPROVED> "Comment_6"*/
 ...
 *
 * @image html  TpsIf_SendCommandOverSPI.jpg
 * @image rtf   TpsIf_SendCommandOverSPI.jpg
 *
...
static boolean TpsIf_SendCommandOverSPI(uint16 u16Command, uint8* u8Data)
{
    ...
    else
    {
    	...
    	/*SAFETYMCUSW 433 S MR:6.1,6.2,10.1,10.2,10.3,10.4 <APPROVED> "Comment_6"*/
        if (TRUE
...
{
	/*SAFETYMCUSW 433 S MR:6.1,6.2,10.1,10.2,10.3,10.4 <APPROVED> "Comment_6"*/
	/*SAFETYMCUSW 576 S MR:11.1 <APPROVED> "Comment_6"*/
