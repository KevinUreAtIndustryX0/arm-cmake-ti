...
/**
 * @brief   get the ADC sampled data of the Diagnostic Pin(Error case which returns FALSE). Used for testing
 *
 *
 * @param [in]  *u16Data received data pointe.After the execution of the API this will hold the sampled data.
 ...
 *              should appropriately make use of the debug information. Used for testing
 *
 */
