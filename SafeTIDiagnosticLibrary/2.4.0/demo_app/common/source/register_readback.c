...
#endif
#if TCMFLASH_ENABLED
#if !(defined(_RM42x_) || defined(_TMS570LS04x_) || defined(_TMS570LC43x_) || defined(_RM57Lx_))
...
#endif
/*Depends on HALCoGen function call - Not implemented in the current version for these devices*/
#if (TCMFLASH_ENABLED && !(defined(_RM42x_) || defined(_TMS570LS04x_) || defined(_TMS570LC43x_) || defined(_RM57Lx_)))
...
#endif
/*Depends on HALCoGen function call - Not implemented in the current version for these devices*/
#if (SRAM_ENABLED && !(defined(_RM42x_) || defined(_TMS570LS04x_) || defined(_TMS570LC43x_) || defined(_RM57Lx_)))
