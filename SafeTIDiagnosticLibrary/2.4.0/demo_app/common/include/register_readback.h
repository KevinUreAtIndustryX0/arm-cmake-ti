...
#include <dcc.h>
#include <rti.h>
#if defined(_TMS570LS31x_) || defined(_RM48x_) || defined(_TMS570LS12x_) || defined(_RM46x_) || defined(_TMS570LS09x_) || defined(_TMS570LS07x_) || defined(_RM44x_)
#include <sys_pmm.h>
#endif
...
#endif
#endif
#if !TCMFLASH_ENABLED //deliberate truncation (temporarily done - remove inversion b4 release)
	tcmflash_config_reg_t	tcmflashCfgReg;
#endif
#if FEE_ENABLED
	fee_config_reg_t		feeCfgReg;
#endif
#if !SRAM_ENABLED  //deliberate truncation (temporarily done - remove inversion b4 release)
