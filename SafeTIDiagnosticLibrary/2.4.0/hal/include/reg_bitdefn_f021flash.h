...
#define F021F_FDIAGCTRL_DMODE_DATA_CORR     (uint32)0x00000001U
#define F021F_FDCTRL_DMODE_DATA_CORR        (uint32)F021F_FDIAGCTRL_DMODE_DATA_CORR /* To support Legacy */
...
#define F021F_FDIAGCTRL_DMODE_P_BUF_PAR     (uint32)0x00000006U
#define F021F_FDIAGCTRL_DMODE_TEST_MODE     (uint32)0x00000007U
#define F021F_FDCTRL_DMODE_P_BUF_PAR        (uint32)F021F_FDIAGCTRL_DMODE_P_BUF_PAR /* To support Legacy */
#define F021F_FDCTRL_DMODE_TEST_MODE        (uint32)F021F_FDIAGCTRL_DMODE_TEST_MODE /* To support Legacy */
