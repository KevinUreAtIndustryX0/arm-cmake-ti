 ...
 * @file        sl_sys_pmu.h
 * @version     2.4.0
 * @brief       API files relevant for the performance monitor unit driver used in SafeTI&trade; Hercules&trade; Diagnostic Library
 *
 * @details The function prototypes of the of the Performance Monitor Unit API's used in SafeTI&trade; Hercules&trade; Diagnostic library\n
